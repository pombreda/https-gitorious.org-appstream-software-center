...
class TestSoftwareChannels(unittest.TestCase):
    ...
    def test_obfuscate_private_ppa_details(self):
        ...
        text = "Failed to fetch https://kingoflimbs:R5kGP7MpK777GMiB7bFw@private-ppa.launchpad.net/commercial-ppa-uploaders/monsterland-mega2000/ubuntu/pool/main/s/monsterland-mega2000/monsterland-mega2000-data_2.00.02797-0maverick1_all.deb SSL connection timeout at 117523"
        expected = "Failed to fetch https://hidden:hidden@private-ppa.launchpad.net/commercial-ppa-uploaders/monsterland-mega2000/ubuntu/pool/main/s/monsterland-mega2000/monsterland-mega2000-data_2.00.02797-0maverick1_all.deb SSL connection timeout at 117523"
