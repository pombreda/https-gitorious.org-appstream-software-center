...
class InstallBackendUI(InstallBackendUI):
    ...
    def ask_medium_required(self, medium, drive):
        dia = AptMediumRequiredDialog(medium, drive)
        res = dia.run()
        dia.hide()
        dia.destroy
    ...
    def error(self, parent, primary, secondary, 
              details=None, alternative_action=None):
...
if __name__ == "__main__":
    ...
    from softwarecenter.ui.gtk.aptd_gtk2 import InstallBackendUI
