...
class AppStore(gtk.GenericTreeModel):
    ...
    def __init__(self, cache, db, icons, search_query=None, 
        ...
        self.apps = []  # XXX: does this actually get used anymore??? -- since today it does
    ...
    def _register_transaction_index_for_pkgname(self, pkgname_to_match):
        for index in range(len(self.matches)):
            ...
            try:
                ...
                pkgname = doc #custom package lists
    ...
    def on_get_value(self, rowref, column):
        ...
        if type(doc) == Application: # custom package list - not found
            app = doc
        ...
        # la la la, no one sees this, do they...
        if self.apps:
